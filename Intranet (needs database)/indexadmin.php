<?php 
    ...
    //datos de alumno 2
    $sql2 = "Select * from alumno_detalle";
...
<!-- Nav Item - Pages Collapse Menu -->
                    ...
                    <div class="row">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Exámenes Evaluados: </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php
                                                    include("bd/conex.php");
                                                    $sql = "SELECT COUNT(*) total FROM examen_curso ";
                                                    $result = mysqli_query($conexion, $sql);
                                                    $fila = mysqli_fetch_assoc($result);
                                                    echo $fila['total'];
                                                    ?></div>
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <center><div style="text-align:center" class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Ingresantes por año</h6>
                                </div></center>
                                <!-- Card Body -->
                                <div class="card-body">
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Desempeño estudiantil</h6>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-success"></i> Nivel Alto
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-danger"></i> Nivel Medio
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-warning"></i> Nivel Bajo
                                        </span>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="js/pie-demo.js"></script>
</body>
